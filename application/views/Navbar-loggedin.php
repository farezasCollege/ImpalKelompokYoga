	        ...
	        <nav class="navbar navbar-default">
	          ...
	          <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
	            <ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-account"><img style="width: 30px; height: 30px;" src="img/signup/account.jpg"></i>username <!-- <?php ?> --><span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                      <li><a href=# >Nama user <!-- <?php ?> --></a></li>
