...
<div class="bg-text">
  ...
  <br>
  <h4 style="color: #00848E; font-family: 'Helvetica'; ">Terimakasih sudah mendaftar</h4>
  <h4 style="color: #00848E; font-family: 'Helvetica';">Silahkan login untuk melakukan booking</h4>
  <br>
